...
##Load image
img1 = cv2.imread("/home/facutk/Desktop/phone_on.png") 
img2 = cv2.imread("/home/facutk/Desktop/phone_off.png") 
height, width = img1.shape[:2]
img2 = cv2.resize(img2,(width, height), interpolation = cv2.INTER_CUBIC)

img3 = cv2.absdiff(img2, img1, img2)
ret, img3 = cv2.threshold(img3,75,255,cv2.THRESH_BINARY)
"""
grey = cv2.imread("/home/facutk/Desktop/phone_on.png",0) #0 for grayscale

##Run Threshold on image to make it black and white
ret, thresh = cv2.threshold(grey,75,255,cv2.THRESH_BINARY)
